package com.android.chat.smack;
...
import com.android.chat.exception.ChatException;
...
public class SmackImpl implements Smack {
	...
	private ChatService mService;// 主服务
	...
	@Override
	public boolean login(String account, String password) throws ChatException {// 登陆实现
		try {
			...
			if (!mXMPPConnection.isConnected()) {
				throw new ChatException("SMACK connect failed without exception!");
			}
			...
			throw new ChatException(e.getLocalizedMessage(),
					e.getWrappedThrowable());
		} catch (Exception e) {
			// actually we just care for IllegalState or NullPointer or XMPPEx.
			LogUtil.e(SmackImpl.class, "login(): " + Log.getStackTraceString(e));
			throw new ChatException(e.getLocalizedMessage(), e.getCause());
		}
	...
	private class PongTimeoutAlarmReceiver extends BroadcastReceiver {
		public void onReceive(Context ctx, Intent i) {
			...
			mService.postConnectionFailed(ChatService.PONG_TIMEOUT);
			logout();// 超时就断开连接
		}
	}
	...
	public void sendOfflineMessages() {
		...
		while (cursor.moveToNext()) {// 遍历之后将离线消息发出
			...
			LogUtil.d("sendOfflineMessages: " + toJID + " > " + message);
	...
	private void registerRosterListener() {
		...
		mRosterListener = new RosterListener() {
			...
			public void presenceChanged(Presence presence) {// 联系人状态改变，比如在线或离开、隐身之类
				LogUtil.i("presenceChanged(" + presence.getFrom() + "): " + presence);
	...
	private void addRosterEntryToDB(final RosterEntry entry) {
		...
		LogUtil.i("addRosterEntryToDB: Inserted " + uri);
	}
	...
	public void addRosterItem(String user, String alias, String group)
			throws ChatException {// 添加联系人，供外部服务调用
	...
	@Override
	public void removeRosterItem(String user) throws ChatException {// 删除联系人，供外部服务调用
		// TODO Auto-generated method stub
	...
	private void removeRosterEntry(String user) throws ChatException {
		mRoster = mXMPPConnection.getRoster();
		try {
	...
	public void renameRosterItem(String user, String newName)
			throws ChatException {// 重命名联系人，供外部服务调用
		// TODO Auto-generated method stub
		mRoster = mXMPPConnection.getRoster();
		RosterEntry rosterEntry = mRoster.getEntry(user);

		if (!(newName.length() > 0) || (rosterEntry == null)) {
			throw new ChatException("JabberID to rename is invalid!");
		}
	...
	public void moveRosterItemToGroup(String user, String group)
			throws ChatException {// 移动好友到其他分组，供外部服务调用
		// TODO Auto-generated method stub
	...
	private void removeRosterEntryFromGroups(RosterEntry rosterEntry)
			throws ChatException {// 从对应组中删除联系人，供外部服务调用
	...
	private void tryToRemoveUserFromGroup(RosterGroup group,
			RosterEntry rosterEntry) throws ChatException {
		try {
