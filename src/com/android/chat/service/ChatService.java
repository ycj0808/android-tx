...
import com.android.chat.activity.BaseActivity;
import com.android.chat.activity.LoginActivity;
import com.android.chat.activity.MainActivity;
import com.android.chat.activity.BaseActivity.BackPressHandler;
...
import com.android.chat.smack.SmackImpl;
...
/**
  ...
  * @Description: TODO
  * @author yangchj
  * @date 2014-4-4 上午10:38:01
  */
public class ChatService extends BaseService implements EventHandler,
		BackPressHandler {
	...
	public IBinder onBind(Intent intent) {
		LogUtil.i(ChatService.class, "[SERVICE] onBind");
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		if (intent != null
				...
				&& TextUtils.equals(intent.getAction(),
						ChatBroadcastReceiver.BOOT_COMPLETED_ACTION)) {
			String account = PreferenceUtils.getPrefString(ChatService.this,
					PreferenceConstants.ACCOUNT, "");
			String password = PreferenceUtils.getPrefString(ChatService.this,
		...
		mConnectingThread = new Thread() {
			...
			public void run() {
				try {
					...
					LogUtil.i(ChatService.class, "YaximXMPPException in doConnect():");
					e.printStackTrace();
				} finally {
					if (mConnectingThread != null)
	...
	private void connectionFailed(String reason) {
		LogUtil.i(ChatService.class, "connectionFailed: " + reason);
	...
	public void newMessage(final String from, final String message) {
		mMainHandler.post(new Runnable() {
			public void run() {
				if (!PreferenceUtils.getPrefBoolean(ChatService.this,
						PreferenceConstants.SCLIENTNOTIFY, false))
					MediaPlayer.create(ChatService.this, R.raw.office).start();
