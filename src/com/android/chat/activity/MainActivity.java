...
import com.android.chat.adapter.RosterAdapter;
import com.android.chat.app.ChatBroadcastReceiver;
import com.android.chat.app.ChatBroadcastReceiver.EventHandler;
import com.android.chat.db.ChatProvider;
import com.android.chat.db.RosterProvider;
import com.android.chat.db.RosterProvider.RosterConstants;
import com.android.chat.fragment.RecentChatFragment;
import com.android.chat.fragment.SettingsFragment;
import com.android.chat.service.IConnectionStatusCallback;
import com.android.chat.service.ChatService;
import com.android.chat.ui.iphonetreeview.IphoneTreeView;
import com.android.chat.ui.pulltorefresh.PullToRefreshBase;
import com.android.chat.ui.pulltorefresh.PullToRefreshScrollView;
import com.android.chat.ui.pulltorefresh.PullToRefreshBase.OnRefreshListener;
import com.android.chat.ui.quickaction.ActionItem;
import com.android.chat.ui.quickaction.QuickAction;
import com.android.chat.ui.quickaction.QuickAction.OnActionItemClickListener;
import com.android.chat.ui.slidingmenu.BaseSlidingFragmentActivity;
import com.android.chat.ui.slidingmenu.SlidingMenu;
import com.android.chat.ui.view.AddRosterItemDialog;
import com.android.chat.ui.view.ChangeLog;
import com.android.chat.ui.view.GroupNameView;
import com.android.chat.util.LogUtil;
import com.android.chat.util.NetUtil;
import com.android.chat.util.PreferenceConstants;
import com.android.chat.util.PreferenceUtils;
import com.android.chat.util.StatusMode;
import com.android.chat.util.ToastUtil;
...
public class MainActivity extends BaseSlidingFragmentActivity implements
	...
	private ChatService mXxService;
	...
	ServiceConnection mServiceConnection = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName name, IBinder service) {
			mXxService = ((ChatService.XXBinder) service).getService();
	...
	public void connectionStatusChanged(int connectedState, String reason) {
		...
		case ChatService.CONNECTED:
			...
			setStatusImage(true);
			break;
		case ChatService.CONNECTING:
			mTitleNameView.setText(R.string.login_prompt_msg);
			mTitleProgressBar.setVisibility(View.VISIBLE);
			mTitleStatusView.setVisibility(View.GONE);
			break;
		case ChatService.DISCONNECTED:
			mTitleNameView.setText(R.string.login_prompt_no);
			mTitleProgressBar.setVisibility(View.GONE);
			mTitleStatusView.setVisibility(View.GONE);
