...
import com.android.chat.activity.AboutActivity;
import com.android.chat.activity.FeedBackActivity;
...
import com.android.chat.ui.switcher.Switch;
import com.android.chat.ui.view.CustomDialog;
...
public class SettingsFragment extends Fragment implements OnClickListener,
	...
	public void onClick(View v) {
		...
		case R.id.btn_exit_comfirm:
			ChatService service = mFragmentCallBack.getService();
			if (service != null) {
				service.logout();// 注销
				...
				.setPositiveButton(android.R.string.yes,
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
								ChatService service = mFragmentCallBack
										.getService();
								if (service != null) {
									service.logout();// 注销
								}
